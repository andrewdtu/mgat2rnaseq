...
#rerun above from here for setup
# Ordinal Analysis
...
```{r MSigDB, fig.height=12, fig.width=8}
...
```{r vst heatmap, fig.width = 12, fig.height = 8}
...
dds_vst_rname = rownames(dds_vst)
dds_vst_cname = colnames(dds_vst)
...
colnames(dds_vst2) <- dds_vst_cname

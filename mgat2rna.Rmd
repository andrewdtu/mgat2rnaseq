...
```{r}
anno_order = match(rownames(dds_vst3), rownames(metadata_3))
anno_df = metadata_3[anno_order, , drop = FALSE]

# Create HeatmapAnnotation object
col_anno = HeatmapAnnotation(
  Diet = anno_df$diet,
  Bile_acid = anno_df$bile_acid,
  Genotype = anno_df$genotype,
  col = list(
    Bile_acid = c("low" = "#5778a4", "high" = "#e49444"),
    Diet = c("low_fat" = "#59A14F", "chow" = "#499894", "high_fat" = "#B6992D"),
    Genotype = c("WT" = "#FF9D9A", "KO" = "#E15759", "FF" = "#D4A6C8", "IKO" = "#B07AA1")
...
Heatmap(transpose_dataframe(dds_vst3), name = "Expression",
        cluster_columns = FALSE,
...
chr_level = intersect(paste0("chr", 1:20), chr)
ha_chr = rowAnnotation(chr = chr,
                       annotation_legend_param = list(chr = list(
